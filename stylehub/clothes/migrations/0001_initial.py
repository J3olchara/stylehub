    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(help_text='Загрузите фото', max_length=255, null=True, upload_to=utils.functions.get_image_upload_location, verbose_name='обложка')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gender', models.CharField(choices=[('male', 'Мужской'), ('female', 'Женский'), ('unisex', 'Унисекс'), ('childish', 'Детский')], default='unisex', help_text='Кто будет носить эту вещь?', max_length=15, verbose_name='пол')),
